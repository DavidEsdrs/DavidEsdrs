...
| <h2 style="background-color: #2e2e2e; padding: 10px; border-radius: 10px">Backend</h2>                                                |<h2 style="background-color: #2e2e2e; padding: 10px; border-radius: 10px">Database</span>                                              | <h2 style="background-color: #2e2e2e; padding: 10px; border-radius: 10px">Frontend</span>                                             |
|--------------------------------------------------------|-------------------------------------------------------|-------------------------------------------------------|
